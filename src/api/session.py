...
from src.api.helpers import send_json
from src.services.llm import MultiLLMManager
from src.services.stt import DeepgramManager
...
class InterviewSession:
    ...
    async def handle_verify_deepgram(self, payload: dict):
        ...
        from src.services.stt import verify_deepgram_api_key
        self._touch()
